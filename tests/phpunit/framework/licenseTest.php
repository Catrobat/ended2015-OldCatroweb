...
class licenseTest extends PHPUnit_Framework_TestCase
{
  ...
  protected function setUp() {
    ...
    $this->blacklist = array("CoreClientDetection.php", "classy.js", "jquery.js", "strings.xml", ".ant-targets-build.xml", "ga.php", "test_no_version.xml", "test_v5a-199_invalid_tag.xml", "test_v5a-420.xml", "test_v5a-433.xml", "test_v5a.xml", "catroweb.html", "normalize.css");
    $this->blacklist_folders = array(".metadata", "addons", "app-building", "pear", "target", "reports", "resources", "pootle", "phpPgAdmin", "cache", "de", "ms", "ro", "ru", "zh-CN", "zh-TW", "ja","lib");
