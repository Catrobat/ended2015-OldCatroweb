...
import at.tugraz.ist.catroweb.common.ExternalLinkTester;
...
public class BaseTest {  
  ...
  protected void startSession(String seleniumHost, int seleniumPort, String browser, String webSite) {
    ...
    session = session();
    System.out.println(" base path:\t"+webSite);
    System.out.println("===========================================================");
  ...
  /** log(String message)
   * logs a message (testng reporter)
   * @param message message to log  
   * @see at.tugraz.ist.catroweb.common.Config#REPORTER_LOG_TO_STD_OUT
   */
