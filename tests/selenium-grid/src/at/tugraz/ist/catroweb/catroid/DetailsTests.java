...
public class DetailsTests extends BaseTest {
  ...
  public void detailsPageCounterLink(HashMap<String, String> dataset) throws Throwable {
    try {
      ...
      By downloadsButton = By.xpath("//*[@id='projectDetailsContainer']/div[2]/div[2]/div/a[1]/div/span");
  ...
  public void checkViewCounter() throws Throwable {
    ...
    driver().navigate().refresh();
    By viewsElement2 = By.xpath("//*[@id='projectDetailsContainer']/div[5]/ul/li[5]/div[2]");
    numOfViews2 = Integer.parseInt(driver().findElement(viewsElement2).getText().split(" ")[0]);
    
    driver().navigate().refresh();
    By viewsElement3 = By.xpath("//*[@id='projectDetailsContainer']/div[5]/ul/li[5]/div[2]");
