...
function getSupportedLanguagesArray($languageHandler) {
  $supportedLanguages = array(
    'ar'=>array('name'=>$languageHandler->getString('template_common_arabic'), 'nameNative'=>'â€«Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©â€¬', 'supported'=>false),
    'bg'=>array('name'=>$languageHandler->getString('template_common_bulgarian'), 'nameNative'=>'â€ªÐ±ÑŠÐ»Ð³Ð°Ñ€Ñ�ÐºÐ¸â€¬', 'supported'=>false),
    'ca'=>array('name'=>$languageHandler->getString('template_common_catalan'), 'nameNative'=>'â€ªcatalÃ â€¬', 'supported'=>false),
    'zh-CN'=>array('name'=>$languageHandler->getString('template_common_chinese_simplified_han'), 'nameNative'=>'â€ªä¸­æ–‡ï¼ˆç®€ä½“ä¸­æ–‡ï¼‰â€¬', 'supported'=>true),
    'zh-TW'=>array('name'=>$languageHandler->getString('template_common_chinese_traditional_han'), 'nameNative'=>'â€ªä¸­æ–‡ (ç¹�é«”ä¸­æ–‡)â€¬', 'supported'=>true),
    'hr'=>array('name'=>$languageHandler->getString('template_common_croatian'), 'nameNative'=>'â€ªhrvatskiâ€¬', 'supported'=>false),
    'cs'=>array('name'=>$languageHandler->getString('template_common_czech'), 'nameNative'=>'â€ªÄ�eÅ¡tinaâ€¬', 'supported'=>false),
    'da'=>array('name'=>$languageHandler->getString('template_common_danish'), 'nameNative'=>'â€ªdanskâ€¬', 'supported'=>false),
    'nl'=>array('name'=>$languageHandler->getString('template_common_dutch'), 'nameNative'=>'â€ªNederlandsâ€¬', 'supported'=>false),
    'en-GB'=>array('name'=>$languageHandler->getString('template_common_english_united_kingdom'), 'nameNative'=>'â€ªEnglish (United Kingdom)â€¬', 'supported'=>false),
    'en'=>array('name'=>$languageHandler->getString('template_common_english_united_states'), 'nameNative'=>'â€ªEnglish (United States)â€¬', 'supported'=>true),
    'et'=>array('name'=>$languageHandler->getString('template_common_estonian'), 'nameNative'=>'â€ªeestiâ€¬', 'supported'=>false),
    'fil'=>array('name'=>$languageHandler->getString('template_common_filipino'), 'nameNative'=>'â€ªFilipinoâ€¬', 'supported'=>false),
    'fi'=>array('name'=>$languageHandler->getString('template_common_finnish'), 'nameNative'=>'â€ªsuomiâ€¬', 'supported'=>false),
    'fr'=>array('name'=>$languageHandler->getString('template_common_french'), 'nameNative'=>'â€ªfranÃ§aisâ€¬', 'supported'=>false),
    'de'=>array('name'=>$languageHandler->getString('template_common_german'), 'nameNative'=>'â€ªDeutschâ€¬', 'supported'=>true),
    'el'=>array('name'=>$languageHandler->getString('template_common_greek'), 'nameNative'=>'â€ªÎ•Î»Î»Î·Î½Î¹ÎºÎ¬â€¬', 'supported'=>false),
    'iw'=>array('name'=>$languageHandler->getString('template_common_hebrew'), 'nameNative'=>'â€«×¢×‘×¨×™×ªâ€¬', 'supported'=>false),
    'hi'=>array('name'=>$languageHandler->getString('template_common_hindi'), 'nameNative'=>'â€ªà¤¹à¤¿à¤¨à¥�à¤¦à¥€â€¬', 'supported'=>false),
    'hu'=>array('name'=>$languageHandler->getString('template_common_hungarian'), 'nameNative'=>'â€ªmagyarâ€¬', 'supported'=>false),
    'id'=>array('name'=>$languageHandler->getString('template_common_indonesian'), 'nameNative'=>'â€ªBahasa Indonesiaâ€¬', 'supported'=>false),
    'it'=>array('name'=>$languageHandler->getString('template_common_italian'), 'nameNative'=>'â€ªitalianoâ€¬', 'supported'=>false),
    'ja'=>array('name'=>$languageHandler->getString('template_common_japanese'), 'nameNative'=>'â€ªæ—¥æœ¬èªžâ€¬', 'supported'=>false),
    'ko'=>array('name'=>$languageHandler->getString('template_common_korean'), 'nameNative'=>'â€ªí•œêµ­ì–´â€¬', 'supported'=>false),
    'lv'=>array('name'=>$languageHandler->getString('template_common_latvian'), 'nameNative'=>'â€ªlatvieÅ¡uâ€¬', 'supported'=>false),
    'lt'=>array('name'=>$languageHandler->getString('template_common_lithuanian'), 'nameNative'=>'â€ªlietuviÅ³â€¬', 'supported'=>false),
    'ms'=>array('name'=>$languageHandler->getString('template_common_malay'), 'nameNative'=>'â€ªBahasa Melayuâ€¬', 'supported'=>true),
    'no'=>array('name'=>$languageHandler->getString('template_common_norwegian'), 'nameNative'=>'â€ªnorskâ€¬', 'supported'=>false),
    'fa'=>array('name'=>$languageHandler->getString('template_common_persian'), 'nameNative'=>'â€«Ù�Ø§Ø±Ø³ÛŒâ€¬', 'supported'=>false),
    'pl'=>array('name'=>$languageHandler->getString('template_common_polish'), 'nameNative'=>'â€ªpolskiâ€¬', 'supported'=>false),
    'pt-BR'=>array('name'=>$languageHandler->getString('template_common_portuguese_brazil'), 'nameNative'=>'â€ªportuguÃªs (Brasil)â€¬', 'supported'=>false),
    'pt-PT'=>array('name'=>$languageHandler->getString('template_common_portuguese_portugal'), 'nameNative'=>'â€ªportuguÃªs (Portugal)â€¬', 'supported'=>false),
    'ro'=>array('name'=>$languageHandler->getString('template_common_romanian'), 'nameNative'=>'â€ªromÃ¢nÄƒâ€¬', 'supported'=>true),
    'ru'=>array('name'=>$languageHandler->getString('template_common_russian'), 'nameNative'=>'â€ªÑ€ÑƒÑ�Ñ�ÐºÐ¸Ð¹â€¬', 'supported'=>true),
    'sr'=>array('name'=>$languageHandler->getString('template_common_serbian'), 'nameNative'=>'â€ªÐ¡Ñ€Ð¿Ñ�ÐºÐ¸â€¬', 'supported'=>false),
    'sk'=>array('name'=>$languageHandler->getString('template_common_slovak'), 'nameNative'=>'â€ªslovenÄ�inaâ€¬', 'supported'=>false),
    'sl'=>array('name'=>$languageHandler->getString('template_common_slovenian'), 'nameNative'=>'â€ªslovenÅ¡Ä�inaâ€¬', 'supported'=>false),
    'es-419'=>array('name'=>$languageHandler->getString('template_common_spanish_latin_america'), 'nameNative'=>'â€ªespaÃ±ol (LatinoamÃ©rica)â€¬', 'supported'=>false),
    'es'=>array('name'=>$languageHandler->getString('template_common_spanish_spain'), 'nameNative'=>'â€ªespaÃ±ol (EspaÃ±a)â€¬', 'supported'=>false),
    'sv'=>array('name'=>$languageHandler->getString('template_common_swedish'), 'nameNative'=>'â€ªsvenskaâ€¬', 'supported'=>false),
    'th'=>array('name'=>$languageHandler->getString('template_common_thai'), 'nameNative'=>'â€ªà¹„à¸—à¸¢â€¬', 'supported'=>false),
    'tr'=>array('name'=>$languageHandler->getString('template_common_turkish'), 'nameNative'=>'â€ªTÃ¼rkÃ§eâ€¬', 'supported'=>false),
    'uk'=>array('name'=>$languageHandler->getString('template_common_ukrainian'), 'nameNative'=>'â€ªÑƒÐºÑ€Ð°Ñ—Ð½Ñ�ÑŒÐºÐ°â€¬', 'supported'=>false),
    'vi'=>array('name'=>$languageHandler->getString('template_common_vietnamese'), 'nameNative'=>'â€ªTiáº¿ng Viá»‡tâ€¬', 'supported'=>false)
  );
