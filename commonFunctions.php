...
function getSupportedLanguagesArray($languageHandler) {
  $supportedLanguages = array(
    'ar'=>array('name'=>$languageHandler->getString('template_common_arabic'), 'nameNative'=>'‫العربية‬', 'supported'=>true),
    ...
    'nl'=>array('name'=>$languageHandler->getString('template_common_dutch'), 'nameNative'=>'‪Nederlands‬', 'supported'=>true),
    ...
    'fr'=>array('name'=>$languageHandler->getString('template_common_french'), 'nameNative'=>'‪français‬', 'supported'=>true),
    ...
    'hu'=>array('name'=>$languageHandler->getString('template_common_hungarian'), 'nameNative'=>'‪magyar‬', 'supported'=>true),
    'id'=>array('name'=>$languageHandler->getString('template_common_indonesian'), 'nameNative'=>'‪Bahasa Indonesia‬', 'supported'=>false),
    'it'=>array('name'=>$languageHandler->getString('template_common_italian'), 'nameNative'=>'‪italiano‬', 'supported'=>true),
    'ja'=>array('name'=>$languageHandler->getString('template_common_japanese'), 'nameNative'=>'‪日本語‬', 'supported'=>true),
    'ko'=>array('name'=>$languageHandler->getString('template_common_korean'), 'nameNative'=>'‪한국어‬', 'supported'=>true),
    ...
    'pl'=>array('name'=>$languageHandler->getString('template_common_polish'), 'nameNative'=>'‪polski‬', 'supported'=>true),
    ...
    'sl'=>array('name'=>$languageHandler->getString('template_common_slovenian'), 'nameNative'=>'‪slovenščina‬', 'supported'=>true),
