<?php
	/**
	 * File: CoreClientDetection.php (formally Browser.php)
	...
	class CoreClientDetection {
		...
		const BROWSER_OPERA_MOBILE = 'Opera Mobile';              // http://www.opera.com/mobile/
		...
		const BROWSER_FIREFOX_MOBILE = 'Firefox Mobile (Fennec)'; // http://www.mozilla.com/en-US/mobile/
		...
		*/
	    ...
	    protected function checkBrowserOpera() {
		    if( stripos($this->_agent,'opera mini') !== false ) {
			    ...
			    $resultant = $this->_agent;
			    if( preg_match('/Version\//',$resultant) ) {
				    $aresult = explode('Version/',$resultant);
				    $this->setVersion($aresult[1]);
				}
			    else {
				    $this->setVersion(0);
			    }
			    $this->_browser_name = self::BROWSER_OPERA_MOBILE;
				$this->setMobile(true);
				return true;
		    }
