            	  ...
            	  <div class ="whiteBoxMain">
            	    ...
            	    <div class="registrationFormContainer">
                  	<form method="post" action="./registration" name="registrationForm">
          		   			...
          		   			Email*<br>
          		   			<input type="text" name="registrationEmail" value="<?php echo htmlspecialchars($this->postData['registrationEmail'])?>" required ><br>
          		   			Birthday*<br>
          		   			<select name="registrationMonth" id="registrationMonth" required ><?php print_r ($this->month) ?></select> <select name="registrationYear" id="registrationYear" required ><?php print_r ($this->year) ?></select required ><br>
          		   			Gender*<br>
