    ...
    <div class="tutorialCardsMainContent">
      <div class="tutorialCardsMainContentDetail">
        <a class="tutorialCardsLinkStyle" href="/tutorialCard?id=1">
          ...
          <div class="tutorialCardsTitle"><?php echo $this->languageHandler->getString('project1_short'); ?></div>
        </a>
      </div>
      <div class="tutorialCardsMainContentDetail">
        <a href="/tutorialCard?id=2">
          ...
          <div class="tutorialCardsTitle"><?php echo $this->languageHandler->getString('project2_short'); ?></div>
        </a>
      </div>
      <div class="tutorialCardsMainContentDetail">
