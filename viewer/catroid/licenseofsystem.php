            ...
            <div class ="whiteBoxMain">
              <div class="licenseText">
                ...
                <ul>
                  ...
                  <li><?php echo $this->languageHandler->getString('terms_of_system_enumeration_2_part_1')?> <i><?php echo $this->languageHandler->getString('terms_of_system_enumeration_2_part_2', '<a href="' . BASE_PATH . '">' . BASE_PATH . '</a>')?></i> <?php echo $this->languageHandler->getString('terms_of_system_enumeration_2_part_3')?> <i><?php echo $this->languageHandler->getString('terms_of_system_enumeration_2_part_4', '<a href="' . BASE_PATH . '">' . BASE_PATH . '</a>')?></i> <?php echo $this->languageHandler->getString('terms_of_system_enumeration_2_part_5')?><br/><br/></li>
