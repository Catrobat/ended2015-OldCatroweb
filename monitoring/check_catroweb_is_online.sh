...
#-------------------------------------------------------------------------------
  ...
  catroweb_upload=$(curl --form upload=@$PWD/tests/phpunit/api/testdata/test.zip --form projectTitle=Monitoring --form token=31df676f845b4ce9908f7a716a7bfa50 --form username=catroweb --form fileChecksum=14a5b75f6092726dbd5df8d12dc5aaf7 --form visible=f $HOST/api/upload/upload.json 2>&1)
