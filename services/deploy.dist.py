...
if __name__ == '__main__':
	...
	try:
		...
		print('')
		print('Options:')
		print('  webtest all           Deploys a new version to web-test.catrob.at.')
		print('  webtest website       Deploys a new version to web-test.catrob.at.')
		print('  catroidtest all       Deploys a new version to catroid-test.catrob.at.')
		print('  catroidtest website   Deploys a new version to catroid-test.catrob.at.')
		print('  public all            Deploys a new version to catroidpublic.ist.tugraz.at.')
		print('  public website        Deploys a new version to catroidpublic.ist.tugraz.at.')
