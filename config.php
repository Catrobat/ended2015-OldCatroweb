...
define('PROJECTS_THUMBNAIL_EXTENTION_ORIG','_original.png');
define('PROJECTS_THUMBNAIL_EXTENTION_SMALL','_small.png');
define('PROJECTS_THUMBNAIL_EXTENTION_LARGE','_large.png');
