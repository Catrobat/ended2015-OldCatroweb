...
define('PROJECTS_FEATURED_EXTENSION','.jpg');
define('PROJECTS_THUMBNAIL_DIRECTORY','resources/thumbnails/');
define('PROJECTS_THUMBNAIL_DEFAULT','thumbnail');
define('PROJECTS_THUMBNAIL_EXTENSION_ORIG','_original.jpg');
define('PROJECTS_THUMBNAIL_EXTENSION_SMALL','_small.jpg');
define('PROJECTS_THUMBNAIL_EXTENSION_LARGE','_large.jpg');
